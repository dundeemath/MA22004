...
This module uses MyDundee (a.k.a Blackboard Ultra)^[Visit [https://my.dundee.ac.uk](https://my.dundee.ac.uk) and search for `MA22004_SEM0100_2122`.] for communicating all announcements/deadlines and also for running online meetings (we will use the Collaborate "Course Room" for online seminars and workshops). This module will use Gradescope^[Available at [https://www.gradescope.com/](https://www.gradescope.com/); "course entry code" at **Welcome > Overview of online platforms used in this course > Gradescope** on Blackboard Ultra.] for submission of continuous assessments and Perusall^[Available through Blackboard Ultra.] for collaborative engagement with reading materials. An **MS Teams channel will be available for contacting the module tutors** and for asynchronous communication. 
...
To take this module, you must have passed module MA12003 or equivalent.
...
If you are having difficulty with the module, you are encouraged to seek help at an early stage by making an appointment with Dr Hall. You may also obtain additional help from the Maths Base (see Ultra for details).
