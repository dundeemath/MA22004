...
This module uses MyDundee (a.k.a Blackboard Ultra)^[Visit [https://my.dundee.ac.uk](https://my.dundee.ac.uk) and search for `MA22004_SEM0100_2122`.] for communicating all announcements/deadlines and also for running online meetings (we will use the Collaborate "Course Room" for online seminars and workshops). This module will use Gradescope^[Available at [https://www.gradescope.com/](https://www.gradescope.com/); "course entry code" available on MyDundee.] for submission of continuous assessments and Perusall^[Available through MyDundee.] for collaborative engagement with reading materials. An **MS Teams channel will be available for contacting the module tutors** and for asynchronous communication. 
...
To take this module, you must have passed module MA12003 Statistics I or equivalent.
...
I would also like to recommend Prof David Spiegelhalter's new book *The Art of Statistics: Learning from Data* [@Spiegelhalter:2020ps].
...
The module will be *continuously* assessed using coursework and class tests. Deadlines, as well as test dates, will be posted on MyDundee and announcements made in the seminars. The module assessment weighting is as follows. 
...
You will be asked to provide peer feedback on a few of the lab exercises. Please participate by providing positive and constructive feedback. If you cannot find anything positive or constructive to write, then please draw a smiley face. `r fa("grin-beam-sweat")`
...
If you are having difficulty with the module, you are encouraged to seek help at an early stage by making an appointment with Dr Hall. You may also obtain additional help from the Maths Cafe (there ).
