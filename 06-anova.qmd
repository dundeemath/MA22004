...
kbl(dattab, col.names = c('Nation', "Average salaries ('000 £)", 'Sample size', 'Sample mean', 'Sample sd'), align = c("l", "l", "c", "c", "c"), booktabs = T, escape = F) |> kable_styling(latex_options = c("striped"))
```
:::
