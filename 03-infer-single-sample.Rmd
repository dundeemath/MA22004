...
ci^2
```
is in good agreement with the values obtained Example \@ref(exm:eg-ci-variance). Due to the computational nature of the interval estimate it is not precisely the same and rerunning the code will yield a slightly different interval. $\lozenge$