...
kbl(dattab, col.names = c('Nation', "Average salaries ('000 £)", 'Size $(m_i)$', 'Sample Mean $(\\overline{x}_i)$', 'Sample SD $(s_i)$'), align = "llccc", caption = "**Average Salary Data** reported from $20$ local councils.", booktabs = T) %>%
