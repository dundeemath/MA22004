...
ggplot(df, aes(x = x, y = y)) + geom_line(aes(y=yhat, color = "regression"), size = 1) + geom_segment(aes(x=x, xend=x, y=y, yend=yhat, color="error"), linetype = 11) + geom_point(alpha = 0.8) +  xlab("Diameter [in]") + ylab("Volume [cu ft]") + theme_lr + theme(legend.title = element_blank()) 
```   
...
ggplot(df, aes(x = x, y = e)) + geom_line(aes(y=0), size = 1) + geom_segment(aes(x=x, xend=x, y=e, yend=0, color="error"), linetype = 11) + geom_point(alpha = 0.8) +  xlab("Diameter [in]") + ylab("Residuals") + theme_lr + theme(legend.title = element_blank())
```   
