...
\begin{equation}
 ...
 (\#eq:ls-residuals)
\end{equation}
The **residual sums of squares**,^[The $\mathsf{RSS}$ is sometimes referred to as the **error sum of squares** and abbreviated $\mathsf{SSE}$ (no, the order is not a typo).]
\begin{equation}
