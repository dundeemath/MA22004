...
`r fa("edit")` Write your work 
\hspace*{1em} `r fa("long-arrow-alt-right")` 
\hspace*{1em} `r fa("file-pdf")` Create a PDF of your work 
\hspace*{1em} `r fa("long-arrow-alt-right")` 
\hspace*{1em} `r fa("cloud-upload-alt")` Upload and Zone your work 

#### Step 1. `r fa("edit")` Write your work {-#step1}
...
#### Step 2. `r fa("file-pdf")` Create a PDF of your work {-#step2}
...
#### Step 3. `r fa("cloud-upload-alt")` Upload and Zone your work {-#step3}

- Log into Gradescope (first time: use the "course access code" on MyDundee).
- Select the module and then the appropriate assignment. 
...
Note that we will meet for synchronous online sessions using Blackboard Collaborate through MyDundee. You must log into MyDundee (Blackboard Ultra), navigate to the module page, and then select "Join session" in the left-hand column. 

Please remember to follow University guidance on registering your attendance. 

```{r bbultra-overview, fig.margin = TRUE, echo = FALSE, fig.cap="An annotated overview of the Blackboard Ultra module landing page.", out.width = "100%", fig.align = "center", fig.pos="h"}
