...
Note that we will meet for synchronous online sessions using Blackboard Collaborate through MyDundee. You must log into MyDundee (Blackboard Ultra), navigate to the course page, and then select "Join session" in the left-hand column. 
