...
We refer to the probability distribution for a statistic as a **sampling distribution**. The sampling distribution illustrates how the statistic will vary across _possible_ sample data. The sampling distribution contains information about the values a statistic is likely to assume and how likely it is to assume those values _prior to observing data_. 

```{definition, sampling-dist}
...
## $\mathsf{t}$ and Cauchy distribution {#t-distribution}
