...
notes. These abbreviations are pretty standard and you might encounter
...
@thm-pie follows from the definition of a probability distribution and
...
probability of $A$ and $B$ occurring is equal to the probability $A$
