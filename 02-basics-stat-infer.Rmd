...
kable(dattab, col.names = c("Height [in]"), caption = "Observations of $m = 31$ felled black cherry trees.")
```    
...
kable(tibble(read_csv("data/htest-null-alt-forms.csv")), caption = "Typical null hypothesis and corresponding alternative hypothesis.")
``` 
