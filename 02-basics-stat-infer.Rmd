...
```{r fig-churchill-ballot, echo = FALSE, warning = FALSE, message = FALSE, fig.cap = "Ballot listing Churchills name from the collection of the McManus, Dundee. When you take a break from studying, go and see if you can find it!"}
